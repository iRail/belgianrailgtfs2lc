...
Connections2JSONLD.prototype._transform = function (connection, encoding, done) {
  ...
  var id = this._baseUris.connections + encodeURIComponent(connection.departureStop) + '/' + encodeURIComponent(connection.departureTime.toISOString().substr(0,10)) + '/' + encodeURIComponent(connection.route);
  done(null, {
    "@id" : id,
    "@type" : "Connection",
